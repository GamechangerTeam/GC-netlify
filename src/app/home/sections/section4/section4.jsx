  ...
  return (
    ...
    <div className="container">
      ...
      <p className="section4__subtitle">
        Наш авторский подход базируется на 18-летнем опыте в
        структурировании бизнес-процессов и гарантирует успешную реализацию
        вашего запроса
      </p>
        ...
        <div className="section4__wrapper">
          ...
          <ul className="section4__list">
            ...
            <li className="section4__card">
              ...
              <p>
                Ваши потребности будут визуализированы на наглядной схеме.
                Наш
            ...
            <li className="section4__card">
              ...
              <p>
                Наш договор гарантирует полную конфиденциальность как в
                период сотрудничества, так и после его завершения. Сроки
                выполнения будут четко зафиксированы и
            ...
            <li className="section4__card">
              ...
              <p>
                ...
                соответствовать техническому заданию. Уже через несколько
                дней ваша система будет готова, включая видеоуроки для
                использования с компьютера и мобильного приложения.
              </p>
            </li>
            <div className="space"></div>
            ...
            <li className="section4__card">
              ...
              <p>
                ...
                сотрудников (офис, производство, выезды) и проведут обучение
                на месте. В течение месяца мы обеспечиваем вашей компании
