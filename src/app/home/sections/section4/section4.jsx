    ...
    <div className="section4" id="section4">
      <div className="container">
        ...
        <p className="section4__subtitle">
          Наш авторский подход базируется на 18-летнем опыте в структурировании
          бизнес-процессов и гарантирует успешную реализацию вашего запроса
        </p>
            ...
            <ul className="section4__list">
              ...
              <li className="section4__card">
                ...
                <p>
                  ...
                  <span className="gold_text">кратчайшие сроки</span> и
                  полностью соответствовать техническому заданию. Уже через
                  несколько дней ваша система будет готова, включая видеоуроки
                  для использования с компьютера и мобильного приложения.
                </p>
              </li>
              <div className="space"></div>
