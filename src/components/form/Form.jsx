...
export default function Form(id) {
  ...
  const [selectedFile, setSelectedFile] = useState(
    "Опишите техническое задание (опционально)"
  );
    ...
    try {
      ...
      const data = {
        fields: {
          ...
          UF_CRM_6738CF09CE9DB: task, // текстовое поле в сделке
          UF_CRM_1731779763: urlToBitrixFile?.result.DETAIL_URL, // ссылка на файл битрикса
        },
  ...
  return (
    <form className="form" id={id} onSubmit={(e) => submitForm(e)}>
      ...
      >
        <Image
          src="https://static.tildacdn.com/tild6536-3233-4639-a462-623563303366/file.svg"
